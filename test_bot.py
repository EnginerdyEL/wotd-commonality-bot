...
def test_dictionary_data(word):
    ...
    try:
        pos, definition, example_sentence, etymology, audio_urls, prn, sense_idx, formality, api_shortdef = mw_tools.get_mw_dictionary_data(word)
...
def test_etymology(etymology_cases_file="etymology_test_cases.json"):
    ...
    for test_case in test_cases:
        ...
        try:
            ...
            _, _, _, etymology, _, _, _, _, _ = mw_tools.get_mw_dictionary_data(word)
